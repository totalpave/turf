...
Takes two or more [polygons][1] and returns a combined polygon. If the input polygons are not contiguous, this function returns a [MultiPolygon][2] feature.

### Parameters

-   `A` **...[Feature][3]&lt;[Polygon][4]>** polygon to combine
